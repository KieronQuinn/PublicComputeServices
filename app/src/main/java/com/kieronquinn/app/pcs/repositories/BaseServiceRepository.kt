...
import com.kieronquinn.app.pcs.repositories.BaseServiceRepository.ServiceResponse
import com.kieronquinn.app.pcs.repositories.BaseServiceRepository.ServiceResponse.FailureReason
...
abstract class BaseServiceRepositoryImpl<I: IInterface>: BaseServiceRepository<I>, KoinComponent {
    ...
    abstract fun I.pingCompat(): Boolean
    abstract fun ServiceConnection.bindService(): Boolean
    abstract fun ServiceConnection.unbindService()
